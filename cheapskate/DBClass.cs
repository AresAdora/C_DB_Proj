...
namespace cheapskate
{
    class DBClass
    {
        ...
        public void Out_DB_Open()
        {
            try
            {
                string connectionString = "User Id=jy2; Password=1234; Data Source=(DESCRIPTION =   (ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521))   (CONNECT_DATA =     (SERVER = DEDICATED)     (SERVICE_NAME = xe)   ) );";
                string commandString = "select outcome_id, amount, text, datein from outcome";
